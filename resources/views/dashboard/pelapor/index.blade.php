                    ...
                    <div class="card mb-1 ml-4" style="width:98%; margin-left: 1%;">
                        <div class="header">
							<div class="row">
								...
								<div class="col-xs-2" >
									...
									<div class="alert alert-success notif " style="font-family: viga;">
											<span>Diterima</span>
									</div>
									@elseif($laporan->status_id == 2)
									<div class="alert alert-warning notif" style="font-family: viga;">
											<span>Diproses</span>
									</div>
									@else
									<div class="alert alert-danger notif" style="font-family: viga;">
											<span>Ditolak</span>
									</div>
									@endif
								</div>
                        ...
                        <div class="content infocon">
                            <div class="row infodes">
                                ...
                                <div class="col-md-6">
									<h5>Alamat</h5>
									<div class="alert kotak " style="margin-bottom: 0px;">
